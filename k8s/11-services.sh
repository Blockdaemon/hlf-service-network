...
expose fabric-ca 7054 ca-${SUBDOMAIN1}
expose fabric-orderer 7050 orderer0

for i in 0 1; do
    expose fabric-peer${i} 7051,7053 peer${i}-${SUBDOMAIN1} # no couchdb
    # expose fabric-peer${i} 7051,7053,5984 peer${i}-${SUBDOMAIN1} # with couchdb
done
